 ...
 * @version 1.0.0
 */
public class ChallengeMessage extends pgrid.util.LexicalDefaultHandler implements PGridMessage, XMLizable {
	 ...
	 */
	public ChallengeMessage(pgrid.GUID guid, String challenge) {
	 ...
	 */
	public int getDesc() {
		return PGridMessage.DESC_CHALLENGE;
	}
	...
	public String getDescString() {
		return PGridMessage.DESC_CHALLENGE_STRING;
	}
	...
	public synchronized void startElement(String uri, String lName, String qName, Attributes attrs) throws SAXException {
		if (qName.equals(XML_CHALLENGE)) {
			mGUID = new pgrid.GUID(attrs.getValue(XML_CHALLENGE_GUID));
