/**
 * $Id: InitMessage.java,v 1.2 2005/11/07 16:56:38 rschmidt Exp $
 *
...
public class InitMessage implements PGridMessage, XMLizable {
	 ...
	 */
	public InitMessage(GUID guid, int port) {
		mGreeting = GREETING;
	...
	/**
	 * Creates a new Gridella init message with the delivered greeting message.
	 *
	...
	public String getDescString() {
		return PGridMessage.DESC_INIT_STRING;
	}
