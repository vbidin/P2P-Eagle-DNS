...
public class TableVersionHandler {
	...
	private static final MutexKeyProvider<TableVersionMutex> MUTEX_KEY_PROVIDER = new MutexKeyProvider<TableVersionMutex>();
	...
	public static UpgradeResult upgradeDBTables(DataSource dataSource, String tableGroupName, DBScriptProvider scriptProvider, Integer initialVersion, Integer maxVersion) throws TableUpgradeException, SQLException {
		...
		synchronized (MUTEX_KEY_PROVIDER.getKey(new TableVersionMutex(dataSource, tableGroupName))) {
	...
	private static void setTableGroupVersion(TransactionHandler transactionHandler, String tableGroupName, int version) throws SQLException {
	...
	public static Integer getTableGroupVersion(DataSource dataSource, TransactionHandler transactionHandler, String tableGroupName) throws SQLException {

		synchronized (MUTEX_KEY_PROVIDER.getKey(new TableVersionMutex(dataSource, tableGroupName))) {
			
			return getTableGroupVersion(transactionHandler, tableGroupName);
		}
	}
	
	private static Integer getTableGroupVersion(TransactionHandler transactionHandler, String tableGroupName) throws SQLException {
	...
	private static Integer getTableGroupVersion(Connection connection, String tableGroupName) throws SQLException {
