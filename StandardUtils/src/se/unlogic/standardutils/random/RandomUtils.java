...
public class RandomUtils {
	...
	public static String getRandomHexColor() {
		...
		return "#" + Integer.toHexString(getRandomInt(0, 255)).toUpperCase() + Integer.toHexString(getRandomInt(0, 255)).toUpperCase() + Integer.toHexString(getRandomInt(0, 255)).toUpperCase();
	}
}
